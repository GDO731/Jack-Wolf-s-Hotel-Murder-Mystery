...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [Tooltip("Whether to use full analog stick magnitude or snap to digital-style movement")]
...
#else
			Debug.LogError( "Input System package is missing. Please install/enable it via Window/Package Manager");
#endif
        ...
        private void CameraRotation()
        {
            ...
            if (_input.LookValue.sqrMagnitude >= _threshold)
            {
                //Don't multiply mouse input by Time.deltaTime
                float deltaTimeMultiplier = IsCurrentDeviceMouse ? 1.0f : Time.deltaTime;

                _cinemachineTargetPitch += _input.LookValue.y * RotationSpeed * deltaTimeMultiplier;
                _rotationVelocity = _input.LookValue.x * RotationSpeed * deltaTimeMultiplier;
        ...
        private void Move()
        {
            ...
            float inputMagnitude = analogMovement ? _input.MoveValue.magnitude : 1f;
